...
const UserSidebar = ({ isOpen }: { isOpen: boolean }) => {
    ...
    return (
        <aside
            className={`fixed z-50 min-h-screen w-full max-w-[60vw] bg-white px-4 transition-transform duration-300 md:max-w-[50vw] lg:max-w-64 ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}
        >
