...
const CourseToday = ({ image, name, createdBy, level, module }: ICourseToday) => {
    return (
        <div className="flex w-full max-w-full cursor-text flex-col gap-4 rounded-lg bg-white p-7 hover:shadow-[0px_40px_100px_0px_#0000000d] hover:transition-all lg:max-w-[360px]">
