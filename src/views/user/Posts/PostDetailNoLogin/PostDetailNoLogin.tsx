...
import { FaFacebookSquare, FaLink, FaRegBookmark } from 'react-icons/fa'
                            ...
                            <div className="flex items-center gap-5 font-medium text-darkGrey">
                                <div className="flex gap-1">
                                    <div className="cursor-pointer">
                                        ...
                                        <PiHeartStraight className="size-7" />
...
export default PostDetailNoLogin
